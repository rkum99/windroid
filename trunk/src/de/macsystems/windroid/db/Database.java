...
public class Database extends SQLiteOpenHelper
{
	...
	public Database(final Context context)
	{
		...
		temp.add("CREATE TABLE IF NOT EXISTS continent (_id INTEGER PRIMARY KEY ,id INTEGER, name TEXT);");
		temp.add("CREATE TABLE IF NOT EXISTS country (_id INTEGER PRIMARY KEY ,id INTEGER, name TEXT);");
		temp.add("CREATE TABLE IF NOT EXISTS region (_id INTEGER PRIMARY KEY ,id INTEGER, name TEXT);");
		//
		temp.add("CREATE INDEX spotindex ON spot (spotid);");
		// temp.add("CREATE INDEX continentindex ON spot (continentid);");
		// temp.add("CREATE INDEX regionindex ON spot (regionid);");
		// //
